  ...
  <div id="app">
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <a href="index.php" class="navbar-brand sidebar-gone-hide">TokoPunya</a>
        ...
        <div class="nav-collapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active"><a href="#" class="nav-link">Tentang TokoPunya</a></li>
        ...
        <?php if (!empty($this->session->userdata('id'))) { ?>
    		 <a href="<?php echo site_url('member/menu_member'); ?>" class="btn btn-outline-light">Menu Member</a>
    		 &nbsp; &nbsp; &nbsp;
